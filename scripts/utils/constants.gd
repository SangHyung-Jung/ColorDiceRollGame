...
# === 주사위 물리 시뮬레이션 ===
const DICE_IMPULSE_RANGE := Vector2(20, 30)  # 주사위 쏟을 때 X축 힘의 범위 (현실적인 값)
const DICE_IMPULSE_Y_RANGE := Vector2(15, 25)  # 주사위 쏟을 때 Y축 힘의 범위 (현실적인 값)
const DICE_IMPULSE_Z_RANGE := Vector2(-10, 10)  # 주사위 쏟을 때 Z축 힘의 범위 (현실적인 값)
